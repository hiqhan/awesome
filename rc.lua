...
tags = {
	names = {"sys","dev","doc","www","chat","media"}
       }
...
vicious.register(netwidget, vicious.widgets.net, 
    function (widget, args)
        if args["{eth0 carrier}"] == 1 then
            return args["{eth0 down_kb}"].." "..args["{eth0 up_kb}"]
        elseif args["{wlan0 carrier}"] == 1 then
            return args["{wlan0 down_kb}"].." "..args["{wlan0 up_kb}"]
        --else
        --    return args["{wlan0 down_kb}"].. " "..args["{wlan0 up_kb}"]
                end
            end, 3)
...
--    else
--        wifiStrength = "Wifi:"..whitespace..wifiStrength.."%"
--    end
--    wifiwidget.text = whitespace..wifiStrength..whitespace
--    f:close()
--end
--
...
for s = 1, screen.count() do
    ...
    mywibox[s].widgets = {
        ...
        mylayoutbox[s],
        mytextclock,
	spacer, seperator, spacer,
	memwidget, spacer, memicon,
	spacer, seperator, spacer,
	thermalwidget, cpuwidget, spacer, cpuicon,
	spacer, seperator, spacer,
	upicon, netwidget, dnicon,
	spacer, seperator, spacer,
    wifiwidget, spacer, wifiicon,
        --batwidget,
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "XF86MonBrightnessDown", function () awful.util.spawn("xrandr --output LVDS --brightness 0.8") end),
    awful.key({ }, "XF86MonBrightnessUp", function () awful.util.spawn("xrandr --output LVDS --brightness 1.0") end),
    ...
    --awful.key({ modkey, "Control" }, "P",     function () awful.util.spawn("sudo poweroff") end),
    --awful.key({ modkey, "Control" }, "R",     function () awful.util.spawn("reboot")    end),
